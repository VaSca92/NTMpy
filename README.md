...
The equation under consideration is: 
 ...
 where *C* = specific heat, *k* = conductivity, *G* is the coupling constant between the two systems (Electron and Lattice)
  ![phiE](https://github.com/VaSca92/NTMpy/blob/master/Pictures/phiE.png?raw=true) and <img src="https://github.com/VaSca92/NTMpy/blob/master/Pictures/phiE.png?raw=true" width="30" height="20" /> 
